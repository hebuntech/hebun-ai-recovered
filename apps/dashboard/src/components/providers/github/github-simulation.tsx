...
import { githubSimulationProfiles } from "@/features/providers/github";

export function GitHubSimulation() {
  return (
    <Card className="h-full">
      ...
      <CardContent className="space-y-3">
        {githubSimulationProfiles.map((profile) => (
          <div key={profile.capability} className="rounded-md border bg-surface-sunken p-4">
            ...
            <p className="mt-2 text-sm text-fg-secondary">
              {profile.sampleResponse.summary}
            </p>
