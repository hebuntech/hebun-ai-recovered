...
export function ClaudeWidget() {
  const tiles = [
    { label: "Status", value: claudeMetrics.status },
    { label: "Simulation", value: claudeMetrics.simulationMode ? "Enabled" : "Disabled" },
    { label: "Capabilities", value: `${claudeMetrics.capabilityCoverage}` },
    { label: "Conformance", value: `${claudeMetrics.conformanceScore}` },
    { label: "Credentials", value: claudeMetrics.credentialStatus },
  ];
  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <Link
          href="/director/providers/claude"
